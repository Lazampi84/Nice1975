...
<div class="container-fluid mt-5">
     <div class="row text-center ">
         <div class="col-12 p-5 justify-content-between fs-2">
                 <p> Nice1975 è sinonimo di qualità e innovazione. Utilizziamo le tecnologie più avanzate per sviluppare prodotti che non solo offrono performance eccellenti, ma sono anche rispettosi dell'ambiente. Le nostre vernici a basso contenuto di VOC (Composti Organici Volatili) sono sicure per te e per il pianeta.</p>
                <p class="mb-5">La nostra lunga esperienza ci ha permesso di creare prodotti che garantiscano performance superiori e un risultato impeccabile rispondendo alle più diverse esigenze.</p>
                <a class="text-decoration-none" href="{{ route('products.index') }}"><button class="btn btnHome fs-2 mt-5">Visita la pagina dei nostri prodotti</button></a>
         </div>
     </div>
</div>
<div class="container-fluid">
     <div class="row text-center">
         <div class="col-12 p-5 justify-content-between  fs-2">
             <p class="mt-3 fs-1 text-center">Impegno per l'Ambiente</p>
            ...
            <p class="mt-5 fs-1 text-center title mb-5">NICE1975...E IL NUOTO IN MARE</p>
            ...
            <p class="mt-5 fs-1 text-center">Partecipazione e Supporto</p>
            <p>La comunità è invitata a supportare la squadra di nuoto partecipando agli eventi, donando fondi e scegliendo le vernici ecologiche Nice 1975 per i propri progetti di decorazione di interni. Ogni acquisto contribuisce a un mare più pulito e a un ambiente più sano.</p>
         </div>
     </div>
 </div>
